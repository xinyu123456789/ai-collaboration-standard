"""Publish one engineer completion JSON. This program never reads signals."""
...
ROLE = "engineer"
REPORT_DIRECTORY = Path("docs/ai-collaboration/reports/engineer")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Publish an engineer completion JSON as the final action.")
